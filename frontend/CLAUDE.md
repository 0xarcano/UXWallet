...
Before writing any code, you MUST review the context files located in `../.context/` to understand whole the project context and `.context/` to understant info related with the specific current subproject.
...
# Tech Stack
- We are using: React and Next.js.
